  ...
  return (
    <div className="flex items-center justify-center">
      ...
      <Button
        variant="bordered"
        color="secondary"
        className="absolute top-4 right-20 h-14 w-24 text-md z-50 bg-white  "
        onPress={onOpen}
      >
        Review
      </Button>
      <Modal isOpen={isOpen} onOpenChange={onOpenChange}>
        <ModalContent>
          {(onClose) => (
            <>
              <ModalHeader>Review and Regenerate your Blog</ModalHeader>
              <ModalBody>
                <Textarea
                  onChange={(e) => {
      ...
      {blog != undefined ? (
        ...
        <>
          <h1>Please wait while we generate your Blog...</h1>
        </>
      )}
    </div>
  );
